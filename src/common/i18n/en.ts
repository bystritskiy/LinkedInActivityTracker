...
export const en = {
  ...
  'dash.diag.allWorking': 'All detectors working',
  'dash.diag.lastCheck': 'last check',
  'dash.diag.issues': 'Some detectors need attention',
  'dash.diag.noHealthData': 'No detector checks recorded yet.',
